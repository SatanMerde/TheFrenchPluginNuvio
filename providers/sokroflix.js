 ...
 * Generated: 2026-08-15T15:34:07.135Z
 */
...
// src/sokroflix/index.js
function getStreams(tmdbId, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      console.log(`[Sokroflix] Request: ${mediaType} ${tmdbId}`);
      const streams = yield extractStreams(tmdbId, mediaType, season, episode);
      return streams;
    } catch (error) {
      console.error(`[Sokroflix] Error: ${error.message}`);
      return [];
    }
  });
}
