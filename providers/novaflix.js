 ...
 * Generated: 2026-08-15T15:41:10.179Z
 */
...
// src/novaflix/extractor.js
var import_cheerio_without_node_native = __toESM(require("cheerio-without-node-native"));
var TMDB_API_KEY = "439c478a771f35c05022f9feabcca01c";
var DOMAIN = "https://novaflix.org";
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (searchHtml) {
        ...
        if (mediaPageUrl) {
          console.log("[Novaflix] Page trouv\xE9e:", mediaPageUrl);
          try {
            ...
            $$("iframe, .player-wrap iframe").each((i, el) => {
              ...
              if (src && !src.includes("google") && !src.includes("analytics") && !src.includes("doubleclick")) {
                ...
                streams.push({
                  name: "Novaflix",
                  title: "\u{1F1EB}\u{1F1F7} MULTI \u2022 " + hostName + " (1080p FHD)",
                  url: playerUrl,
                  quality: "1080p",
                  headers: HEADERS
                });
            ...
            console.log("[Novaflix] Erreur scraping page:", pageErr.message);
          }
        }
      }
      if (streams.length === 0) {
      ...
      console.error("[Novaflix] Erreur globale:", error);
      return [];
    }
    return streams;
  });
...
// src/novaflix/index.js
function getStreams(tmdbId, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      console.log(`[Novaflix] Request: ${mediaType} ${tmdbId}`);
      const streams = yield extractStreams(tmdbId, mediaType, season, episode);
      return streams;
    } catch (error) {
      console.error(`[Novaflix] Error: ${error.message}`);
      return [];
    }
  });
}
