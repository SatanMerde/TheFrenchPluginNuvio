 ...
 * Generated: 2026-08-15T15:41:10.083Z
 */
...
// src/choupox/extractor.js
var import_cheerio_without_node_native = __toESM(require("cheerio-without-node-native"));
var TMDB_API_KEY = "439c478a771f35c05022f9feabcca01c";
var DOMAIN = "https://choupox.com";
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (searchHtml) {
        ...
        if (mediaPageUrl) {
          console.log("[Choupox] Page trouv\xE9e:", mediaPageUrl);
          try {
            ...
            $$("iframe, .embed-responsive iframe").each((i, el) => {
            ...
            console.log("[Choupox] Erreur scraping page:", pageErr.message);
          }
        }
      }
      if (streams.length === 0) {
      ...
      console.error("[Choupox] Erreur globale:", error);
      return [];
    }
    return streams;
  });
...
// src/choupox/index.js
function getStreams(tmdbId, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      console.log(`[Choupox] Request: ${mediaType} ${tmdbId}`);
      const streams = yield extractStreams(tmdbId, mediaType, season, episode);
      return streams;
    } catch (error) {
      console.error(`[Choupox] Error: ${error.message}`);
      return [];
    }
  });
}
