/**
 * Filmstoon Real Web Scraper for Nuvio
 */
import { fetchText, HEADERS } from './http.js';
import cheerio from 'cheerio-without-node-native';

const TMDB_API_KEY = "439c478a771f35c05022f9feabcca01c";
const DOMAIN = "https://filmstoon.pro";
...
export async function extractStreams(tmdbId, mediaType, season, episode) {
    ...
    try {
        ...
        console.log("[Filmstoon] Scraping direct pour:", searchTitle, "(" + type + ")");
        ...
        try {
            ...
            console.log("[Filmstoon] Recherche inaccessible:", fetchErr.message);
        }
        ...
        if (searchHtml) {
            ...
            if (mediaPageUrl) {
                console.log("[Filmstoon] Page trouvée:", mediaPageUrl);
                try {
                    ...
                    console.log("[Filmstoon] Erreur scraping page:", pageErr.message);
                }
            }
        }
        ...
        console.error("[Filmstoon] Erreur globale:", error);
        return [];
    }
